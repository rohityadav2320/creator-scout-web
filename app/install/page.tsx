...
const MAC_COMMANDS = `F=$(find ~/Downloads ~/Desktop -maxdepth 3 -name 'CreatorScout-Agent-Mac*' -type f -print0 2>/dev/null | xargs -0 ls -t 2>/dev/null | head -1); echo "Found: $F"; xattr -cr "$F"; chmod +x "$F"; "$F"`;
